...
const FeaturedPlans = () => {
  ...
  const fetchAllFeaturedPlans = async () => {
    try {
      setLoading(true);
      setError(null);
      ...
      setFeaturedPlans(response.data.data || []);
    } catch (error) {
      ...
      <div className="container">
        <div className="section_title light centred">
          <div className="tag_text">
            <h6>Featured Plans</h6>
          </div>
          <h2>Our Featured Investment Plans</h2>
        </div>
