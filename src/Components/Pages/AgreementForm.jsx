...
const AgreementForm = () => {
  ...
  useEffect(() => {
    ...
    const serviceCost = 150000; // 1.5L per service
    const additionalAmount = selectedServices.length * serviceCost;
    const base = baseAmount[serviceChoice] || 0;
    const total = base + additionalAmount;
    setTotalAmount(total);
    setTotalWithGST(total + total * 0.18); // Calculate total with 18% GST
  }, [selectedServices, serviceChoice, baseAmount]);
  ...
  const renderServicesCheckboxes = () => {
    ...
    const totalAmount = selectedServices.reduce((sum, _, index) => {
      return sum + (tieredPrices[index] || 0);
    }, 0);

    const totalWithGST = totalAmount + totalAmount * 0.18;
    ...
    return (
      <div style={{ marginTop: "20px" }}>
        ...
        {selectedServices.length >= 4 && (
          ...
          >
            Maximum 4 services can be selected (₹4L + GST total)
          </div>
        )}
        ...
        >
          ...
          <div style={{ textAlign: "right" }}>
            <div style={{ fontSize: "16px", color: "#666" }}>
              Base: ₹{totalAmount.toLocaleString("en-IN")}
            </div>
            <div style={{ fontSize: "16px", color: "#666" }}>
              GST (18%): ₹{(totalAmount * 0.18).toLocaleString("en-IN")}
            </div>
            <div
              style={{
                fontSize: "24px",
    ...
    >
      ...
      >
        ...
        >
          ...
          {loading.free && loading.individual && loading.business && loading.institutional ? (
            renderLoadingCards()
          ) : (
            <>
              {/* Free Card */}
              ...
              >
                  ...
                  <div>
                    <h5
                      style={{
                        margin: 0,
                        color:
                          serviceChoice === "individual" ? "#00833D" : "#2c3e50",
                        fontSize: "20px",
                        fontWeight: "700",
                        transition: "all 0.3s ease",
                      }}
                ...
                >
                  <div>
                    ...
                    >
                      ...
                      >
                        ₹{baseAmount.individual || "2.5L each"}
                      </span>
                      <span
                        style={{
                          fontSize: "14px",
                ...
                <div
                  style={{
                    ...
                    border:
                      serviceChoice === "individual" ? "none" : `1px solid #00833D`,
                    padding: "12px",
                    borderRadius: "8px",
                    textAlign: "center",
                    fontWeight: "600",
              ...
              >
                ...
                >
                  ...
                  <div>
                    <h5
                      style={{
                        margin: 0,
                        color: serviceChoice === "business" ? "#00833D" : "#2c3e50",
                        fontSize: "20px",
                        fontWeight: "700",
                        transition: "all 0.3s ease",
                      }}
                ...
                <div
                  style={{
                    ...
                    border:
                      serviceChoice === "business" ? "none" : `1px solid #00833D`,
                    padding: "12px",
                    borderRadius: "8px",
                    textAlign: "center",
                    fontWeight: "600",
                  ...
                  <div>
                    <h5
                      style={{
                        margin: 0,
                        color:
                          serviceChoice === "institutional" ? "#00833D" : "#2c3e50",
                        fontSize: "20px",
                        fontWeight: "700",
                        transition: "all 0.3s ease",
                      }}
                ...
                >
                  <div>
                    ...
                    >
                      ...
                      >
                        ₹{baseAmount.institutional || "2.5L each"}
                      </span>
                      <span
                        style={{
                          fontSize: "14px",
                  ...
                  style={{
                    background:
                      serviceChoice === "institutional"
                        ? "linear-gradient(135deg, #00833D, #000000)"
                        : "transparent",
                    color: serviceChoice === "institutional" ? "white" : "#00833D",
                    border:
                      serviceChoice === "institutional"
                        ? "none"
                        : `1px solid #00833D`,
      ...
      {serviceChoice && serviceChoice !== "free" && (
        ...
        >
          ...
          >
            ...
            >
              Select Additional Services (₹2,50,000 + GST each)
            </h5>
          </div>
